...
const Blogs = () => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            try {
                const [recentBlogsAPI, popularBlogAPI] = await Promise.all([
                    api.get("/post/index"),
                    api.get("/post/index/popular")
                ])
                setRecentBlogPosts(recentBlogsAPI.data.posts.filter((post) => post.type === "Blog"));
    ...
    return(
        <>
            ...
            <div className="flex flex-col gap-4 bg-emerald-950 py-8 px-4 md:px-24">
                <h1 className="text-xl md:text-3xl text-white">Recent Blogs</h1>
            ...
            <div className="flex flex-col gap-4 bg-emerald-950 py-8 px-4 md:px-24 text-white">
                <h1 className="text-xl md:text-3xl">Popular Blogs</h1>
