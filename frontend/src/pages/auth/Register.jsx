                ...
                <div className="flex flex-col md:w-1/2 md:justify-center md:items-center py-8 px-12 gap-2 md:gap-4">
                    ...
                    <form action="" className="flex flex-col gap-4 md:gap-6 md:text-lg">
                        <div className="flex flex-col">
                            <label>Email</label>
                            <input type="email" placeholder="email" className="bg-transparent text-emerald-950 p-2 border-2 border-emerald-950 rounded-md focus:outline-none focus:border-b-2 focus:border-b-emerald-950" required />
                        </div>
                        <div className="flex flex-col">
                        ...
                        <div className="flex flex-col">
                            ...
                            <input type="password" placeholder="confirm password" className="bg-transparent text-emerald-950 p-2 border-2 border-emerald-950 rounded-md focus:outline-none focus:border-b-2 focus:border-b-emerald-950" required />
                        </div>
